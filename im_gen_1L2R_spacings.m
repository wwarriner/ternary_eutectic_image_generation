...
function im_gen_1L2R_spacings( output_root_path )
...
output_path = [ output_root_path, filesep, 'spacings' ];
if ~exist( output_path, 'dir' )
    mkdir( output_path );
end
    
for lambda_1 = 20:20:200
    
   for lambda_2 = 20:20:200
    ...
    % generate file name
    file_name = [ '1L2R_spacing_only_', num2str( lambda_1 ), '_', num2str( lambda_2 ) ];
