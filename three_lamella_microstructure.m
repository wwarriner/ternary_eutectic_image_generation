...
function microstructure = three_lamella_microstructure( ...
...
% THREE_LAMELLA_MICROSTRUCTURE
% DESCRIPTION
%
% Function creates a ternary-valued array representing an image of an
% idealized three-lamella ternary eutectic microstructure.
% 
...
%returns the volume fraction closest to the input desired volume 
%fraction is used.
...
b = beta_spacing_px * volume_fraction_beta_phase;
